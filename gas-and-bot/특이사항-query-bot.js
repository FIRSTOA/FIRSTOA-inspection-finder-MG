/**
 * 담당자/명의/주소변경 특이사항 질의응답 봇 (v0.7.39a+)
...
// ===================== 설정 =====================
const WEBHOOK_URL   = 'https://hook.eu2.make.com/fduspq7ggud5c2k1uxwuu34gks9pxo23';
const ALLOWED_ROOMS = ['신)담당자/명의/주소변경등 특이사항'];   // 처리할 방 (정확한 방 제목)
// ================================================
