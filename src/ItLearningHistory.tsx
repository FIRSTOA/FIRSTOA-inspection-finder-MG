...
export default function ItLearningHistory({ author }: { author: string }) {
  ...
  return <div className="space-y-4">
    ...
    {view === "quiz" && <section className="border border-slate-200 bg-white p-4 shadow-sm">
