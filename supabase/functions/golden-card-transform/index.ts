...
function buildInstruction(quarterLabel: string) {
  return [
    ...
    "",
    "[입력 자료 우선순위]",
    "1순위: 현재 분기 기본업무/목표/결과표 (수치·달성률의 근거)",
    "2순위: 현재 분기 미션/상세 실행 결과표",
    "3순위: weeklyRecordsText — 주간 성장노트·배운 점·아이디어 (q3 학습·지식, q2 기여의 근거)",
    "4순위: 참고용 기존 골든미팅카드 결과 예시 (문체 참고용)",
    "위 입력 자료에 없는 내용은 골든미팅카드에 작성하지 않는다.",
